...
function exp_label_Aduan_JKR_Hupk_2_eval_expression(context) {
    ...
    if (feature.properties) {
        return ((('Tarikh Aduan: ' + feature.properties['Tarikh Aduan'] ) + '\nAduan: ') + fnc_left([feature.properties['Ringkasan_Aduan'] ,20], context));
    } else {
        return ((('Tarikh Aduan: ' + feature['Tarikh Aduan'] ) + '\nAduan: ') + fnc_left([feature['Ringkasan_Aduan'] ,20], context));
    }
}
...
function exp_Aduan_JKR_Hupk_2rule0_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.properties['Status']  == 'Belum Tutup');
    } else {
        return (feature['Status']  == 'Belum Tutup');
    }
}
...
function exp_Aduan_JKR_Hupk_2rule1_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.properties['Status']  == 'Tutup');
    } else {
        return (feature['Status']  == 'Tutup');
    }
}
